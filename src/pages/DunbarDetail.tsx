        ...
        <>
          <div style={styles.card}>
            ...
            <p style={styles.footerLine}>
              {totalPeople > DUNBAR_LIMIT
                ? `Those ${totalPeople - DUNBAR_LIMIT} are people most brains would have quietly let fade. Grove is keeping the thread for all of them.`
                : "You're within the range most brains can track unaided — Grove's still here to keep the detail sharp as that list grows."}
            </p>
          </div>
