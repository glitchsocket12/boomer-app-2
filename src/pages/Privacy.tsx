  ...
  return (
    <div style={styles.page}>
      ...
      <p style={styles.intro}>
        Grove is private by default. Nobody but you can see what's here — no public profile,
      ...
      <section style={styles.section}>
        ...
        <p style={styles.body}>
          Grove's AI reads your notes to organize them — sorting out who's who, pulling out
      ...
      <section style={styles.section}>
        ...
        <p style={styles.body}>
          We use a small number of outside services to run Grove: Supabase (where your data
