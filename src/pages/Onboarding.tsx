      ...
      <div style={styles.card}>
        ...
        {selfPerson && stage === 'welcome' && (
          <>
            ...
            <p style={styles.body}>
              Grove is organized around a few simple ideas: <strong>People</strong> hold everything about
        ...
        {selfPerson && stage === 'tree' && (
          <>
            ...
            <p style={styles.body}>
              We start here because it's the fastest way to show you how Grove actually works: everyone gets
            ...
            <p style={styles.body}>
              ...
              the more useful your family tree (and the rest of Grove) becomes.
            </p>
        ...
        {selfPerson && stage === 'groups' && groupQueue.length === 0 && (
          <>
            ...
            <p style={styles.body}>
              ...
              groups they belong to now pays off later, when Grove can tag events and photos to the whole
        ...
        {selfPerson && stage === 'guide' && (
          <>
            <h1 style={styles.title}>Here's how Grove works</h1>
            <ul style={styles.featureList}>
              <li style={styles.featureItem}>
                <strong>Home</strong> is the chat. Type or tap the mic and just talk — Grove
                sorts out who you're talking about. Quick counts and a couple of AI-suggested
                things worth capturing live here too.
              </li>
              <li style={styles.featureItem}>
                <strong>People</strong> — everyone Grove knows about gets their own page: key
        ...
        {selfPerson && stage === 'handoff' && (
          <>
            ...
            <p style={styles.body}>
              That's enough to make Grove genuinely useful right away — you can always keep building from here,
...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  dotWrap: { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: space.sm },
  dot: { width: '10px', height: '10px', borderRadius: radius.circle, backgroundColor: colors.dividerWarm },
  dotActive: { backgroundColor: colors.tree },
  dotDone: { backgroundColor: colors.primary },
  dotLabel: { fontSize: fontSize.micro, color: colors.textFaintest },
  title: { fontSize: '1.8rem', color: colors.ink, margin: '0 0 1rem' },
  body: { fontSize: fontSize.base, color: neutral.grey800, lineHeight: 1.6, marginBottom: space.xxl },
  featureList: {
    listStyle: 'none',
    padding: 0,
    margin: '0 0 1.25rem',
  ...
  featureItem: { fontSize: fontSize.base, color: neutral.grey800, lineHeight: 1.6 },
  buttonRow: { display: 'flex', alignItems: 'center', gap: space.xxl, flexWrap: 'wrap', marginTop: space.md },
  primaryButton: {
    fontSize: '1.05rem',
  ...
  treeWrap: { border: `1px solid ${neutral.grey50}`, borderRadius: radius.lg, padding: '0.5rem 0.5rem 0', marginBottom: space.md },
  typeGrid: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: space.lg, marginBottom: space.xxxl },
  typeCard: {
    textAlign: 'left',
  ...
  typeCardSelected: { border: `2px solid ${neutral.forest}`, backgroundColor: neutral.sageWashLight },
  typeCardTitle: { fontSize: fontSize.base, color: colors.ink, marginBottom: space.xs },
  typeCardExample: { fontSize: fontSize.small, color: colors.textFaint },
  label: { display: 'flex', flexDirection: 'column', gap: '0.4rem', fontSize: fontSize.bodyLg, color: colors.inkPlain, marginBottom: space.xl },
  input: { fontSize: '1.05rem', padding: '0.65rem', borderRadius: radius.md, border: border.default, fontFamily },
  textarea: {
  ...
  inlineForm: { display: 'flex', gap: space.lg, flexWrap: 'wrap' },
}
