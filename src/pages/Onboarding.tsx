...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  treeWrap: { border: '1px solid #EEE', borderRadius: radius.lg, padding: '0.5rem 0.5rem 0', marginBottom: space.md },
  ...
  typeCardSelected: { border: '2px solid #2E4034', backgroundColor: neutral.sageWashLight },
