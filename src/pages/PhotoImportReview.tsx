...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  section: { backgroundColor: colors.surface, border: border.inkPale, borderRadius: radius.lg, padding: '1rem 1.1rem', marginBottom: '1rem' },
  ...
  inlineLink: { background: 'none', border: 'none', color: colors.ink, textDecoration: 'underline', cursor: 'pointer', fontFamily, fontSize: fontSize.body, padding: 0 },
  ...
  thumb: { width: '64px', height: '64px', objectFit: 'cover', borderRadius: radius.md, border: `1px solid ${neutral.grey50}` },
  thumbPlaceholder: { width: '64px', height: '64px', borderRadius: radius.md, backgroundColor: colors.divider },
  thumbMore: { width: '64px', height: '64px', borderRadius: radius.md, backgroundColor: neutral.sageWash, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: fontSize.label, color: colors.ink },
  clusterDate: { fontSize: fontSize.body, color: colors.inkPlain, margin: '0 0 0.25rem', fontWeight: 'bold' },
  clusterChoice: { fontSize: fontSize.label, color: colors.textMuted, margin: '0 0 0.5rem' },
  titleInput: {
    display: 'block',
    width: '100%',
