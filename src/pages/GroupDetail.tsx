...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  personSelected: { backgroundColor: colors.primary, color: colors.onFill },
  ...
  subgroupTileDroppable: { border: `1px dashed ${colors.primary}`, backgroundColor: colors.inkWash },
  subgroupTileDropActive: { border: `2px solid ${colors.primary}`, backgroundColor: colors.inkPale },
  dragOverlayPill: {
    fontSize: fontSize.body,
    padding: '0.5rem 1rem',
    borderRadius: radius.pill,
